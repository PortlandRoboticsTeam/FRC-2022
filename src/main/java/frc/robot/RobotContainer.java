...
import frc.robot.commands.AutoCommands.AutoMoveShootTwo;
...
public class RobotContainer {
  ...
  private final ShootBall retractBall = new ShootBall(ballGun, -launchSpeed);
  ...
  private void configureButtonBindings() {
    JoystickButton m_2 = new JoystickButton(m_controller, 2);
    ...
    m_2.whenPressed(retractBall);
    m_2.whenReleased(shootBallStop);
